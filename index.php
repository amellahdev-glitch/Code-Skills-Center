        ...
        <div class="hero-container">
            <div class="hero-content">
                <div class="flex-column">
                    <h1 class="fade-in">L'excellence formation professionnelle: <br><span class="text-gradient">Développer vos compétences avec TULUA Institue</span></h1>
                <p class="fade-in delay-1">Une large gamme de formations adaptées à vos ambitions, conçues par des experts de l'industrie pour propulser votre carrière.</p>
                ...
                <div class="student-card fade-in delay-2">
                    ...
                    <div class="card-buttons">
                        <button class="btn btn-primary" onclick="openModal('registerModal')">Démarrez mon inscription</button>
                        <button class="btn btn-dark" onclick="openModal('loginModal')">Connecter à mon compte</button>
                    </div>
                </div>
            </div>
        </div>
        <div id="carouselExampleAutoplaying" class="carousel slide my-auto d-none d-md-block align-items-center w-75" data-bs-ride="carousel">
            <div class="carousel-inner rounded-4 overflow-hidden">
                <div class="carousel-item active">
                <img src="https://i.pinimg.com/736x/4f/11/26/4f11264df3395d91125b1d8fd4b929e9.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item rounded-4">
                <img src="https://i.pinimg.com/736x/b2/03/1c/b2031c8c39c0e278d2909f375926c756.jpg" class="d-block w-100" alt="...">
            </div>
            
            <div class="carousel-item rounded-4">
                <img src="https://i.pinimg.com/736x/b1/70/f3/b170f38632dd8804206fccaef4916240.jpg" class="d-block w-100" alt="...">
            </div>
